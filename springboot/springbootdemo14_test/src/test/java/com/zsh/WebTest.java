...
public class WebTest {
    ...
    public void testStatus(@Autowired MockMvc mvc) throws Exception {
        ...
        //添加预计值到本次调用过程中进行匹配
        ResultActions actions = action.andExpect(ok);
    ...
    public void testBody(@Autowired MockMvc mvc) throws Exception {
        ...
        ResultMatcher body = content.string("spring boot");
    ...
    public void testJson(@Autowired MockMvc mvc) throws Exception {
        ...
        ContentResultMatchers content = MockMvcResultMatchers.content();
        ResultMatcher json = content.json("{\"id\":1,\"name\":\"springboot\",\"type\":\"springboot\",\"description\":\"springboot\"}");
...
//        ContentResultMatchers content = MockMvcResultMatchers.content();
//        ResultMatcher json = content.contentType("application/json");
