...
//        OutputStream os=new FileOutputStream("day09/src/out04.txt");//重写
        OutputStream os=new FileOutputStream("day09/src/out04.txt",true);//追加
        ...
        os.write('a');
        os.write(98);
        os.write('徐');//汉字是三个字节  这里只写进去徐的第一个字节 会造成乱码
