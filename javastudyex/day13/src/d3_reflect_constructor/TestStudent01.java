...
public class TestStudent01 {
    ...
    // 获取某个构造器：只能拿public修饰的某个构造器
        ...
        public void getConstructor() throws Exception {
            Class c1=Student.class;
            Constructor constructors = c1.getConstructor(String.class,int.class);
            System.out.println(constructors.getName()+"====>"+constructors.getParameterCount());
        }

    // 4.getDclaredConstructor(Class... parameterTypes)
    // 获取某个构造器：只要你敢写，这里就能拿到，无所谓权限是否可及。
    @Test
        public void getDclaredConstructor() throws Exception {
        Class c1=Student.class;
